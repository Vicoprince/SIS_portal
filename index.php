                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    include_once("dbcon.php");
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM `student_data` WHERE `status` = 'approved' ") or die(mysqli_error($con));
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Lecturers
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    include_once("dbcon.php");
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM `lecturer_info`") or die(mysqli_error($con));
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    include_once("dbcon.php");
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM `departments` ") or die(mysqli_error($con));
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    include_once("dbcon.php");
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM `student_data` WHERE `status` = 'pending' ") or die(mysqli_error($con));
