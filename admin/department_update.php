...
<head>
    ...
    <title>HCT - Department Update</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                        <div>
                            <a href="./department_list.php" class="btn btn-primary"><i
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Department Update</h6>
                    </div>
                ...
                <?php 
                    ...
                    $sql_qry = "SELECT * FROM `departments` WHERE `id` = '$id'";
            ...
            <form action="" method="POST" id="course-form" data-select2-id="[object HTMLInputElement]">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="dept_name" id="name" class="form-control form-control-border" placeholder="Enter Department Name" value="<?php echo $name ?>" required="">
                </div>
                <div class="form-group">
                    <label for="name" class="control-label">HOD</label>
                    <input type="text" name="hod" id="name" class="form-control form-control-border" placeholder="Enter H.O.D Name" value="<?php echo $hod ?>" required="">
                </div>
                <div class="form-group">
            ...
            ?>
                    ...
                    <?php
                        ...
                        if(isset($_POST["update_course"])) {
                            $updatedept_name = $_POST["dept_name"];
                            $updatehod = $_POST["hod"];
                            $updateCourse_description = $_POST["course_description"];
                            $updateStatus = $_POST["status"];

                            $update_query = "UPDATE `departments` SET `name`='$updatedept_name',`description`='$updateCourse_description',`HOD`='$updatehod',`status`='$updateStatus' WHERE id = $id";
