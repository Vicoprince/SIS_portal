...
?>
	...
	include("../dbcon.php");
  	...
  	$qry = "SELECT * FROM `course_list` WHERE `id` = '$id'";
		...
		if(mysqli_num_rows($run)<1){
			...
			while($data = $run->fetch_assoc()){
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">No. :  <?php echo $courseId ?></li>
                    <li class="list-group-item">Department : <?php echo $data['department']; ?></li>
                    <li class="list-group-item">Course Name : <?php echo $data['course_name']; ?></li>
                    <li class="list-group-item">Course Description : <?php echo $data['course_description']; ?></li>
                    <li class="list-group-item">Status : <?php echo "<span class=\"$statusClass\"> $status "?></span></li>
                </ul>
                <div>
                    <a href="./course_update.php?update=<?php echo $data['id']; ?>" class="btn btn-primary"> Update</a>
                </div>
                <?php
			}
		}
