...
<head>
    ...
    <title>HCT - Department Info</title>
		...
		if(mysqli_num_rows($run)<1){
			...
			while($data = $run->fetch_assoc()){
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">No. :  <?php echo $deptId ?></li>
                    <li class="list-group-item">Department Name: <?php echo $data['name']; ?></li>
                    <li class="list-group-item">H.O.D : <?php echo $data['HOD']; ?></li>
                    <li class="list-group-item">Department Description : <?php echo $data['description']; ?></li>
                    <li class="list-group-item">Status : <?php echo "<span class=\"$statusClass\"> $status "?></span></li>
                </ul>
                <div>
                    <a href="./department_update.php?update=<?php echo $data['id']; ?>" class="btn btn-primary"> Update</a>
                </div>
                <?php
			}
		}
